...
require_once 'class_penelitian.php';

$tujuan = new suratPenelitian();
$dataTujuan = $tujuan->tampilData('Penelitian')
?>
...
<div class="container mt-5">
    <h4 class="text-center">Data Surat Tugas Penelitian</h4>
